        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="contact-form bg-white" style="padding: 30px;">
                    <div id="success"></div>
                    <form action="/admins/tours" method="POST"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="control-group col-sm-6">
                                <input type="text" name="price" class="form-control p-4" id="price" placeholder=" price"
                                    required="required" data-validation-required-message="Please enter  price" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group col-sm-6">
                                <input type="text" class="form-control p-4" name="time" id="time" placeholder="Your time"
